...
def initialize_llm():
    ...
    try:
        # Ensure GOOGLE_API_KEY is set in environment for CrewAI
        import os
        os.environ['GOOGLE_API_KEY'] = GOOGLE_API_KEY
        
        # CrewAI 1.3.0 with v1beta API requires 'google/gemini-2.0-flash-exp'
        # Note: Gemini 1.5 models are not available in v1beta API version
        model = 'google/gemini-2.0-flash-exp'
        logger.info("LLM initialized successfully for CrewAI")
        return model
